...
_C.CAS = CfgNode()
_C.CAS.ENABLED = True
_C.CAS.ANCHOR_GAMMA = 0.9
_C.CAS.ANCHOR_WARMUP = 3
_C.CAS.ANCHOR_LAYERS = []

# ------------------------------ OATTA options ----------------------------- #
_C.OATTA = CfgNode()
_C.OATTA.ENABLED = True
_C.OATTA.GAMMA = 0.1
_C.OATTA.TAU = 1.0
_C.OATTA.USE_LLR = True
_C.OATTA.LLR_WINDOW = 10
_C.OATTA.LLR_MARGIN = 1.0
_C.OATTA.LLR_TAU = 1.0
_C.OATTA.ETA = 0.1
...
def get_num_classes(dataset_name: str):
    dataset_name2num_classes = {"cifar10": 10, "cifar10_c": 10, "cifar100": 100,  "cifar100_c": 100,
                                "imagenet": 1000, "imagenet_v2": 1000, "imagenet_c": 1000, "imagenet100_c": 100, "ccc": 1000,
